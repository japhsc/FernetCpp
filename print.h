...
void print(unsigned char* c_data, size_t len) {
    ...
    std::cout << "data (" << len << " byte): " << std::endl
              << "\t" << sizeof(char) << " (char), " << sizeof(int) << " (int), " << sizeof(size_t)
              << " (size_t), " << sizeof(long int) << " (long int), " << sizeof(uint64_t)
              << " (uint64_t), " << std::endl
              << "\t" << sizeof(float) << " (float), " << sizeof(double) << " (double), "
              << sizeof(long double) << " (long double)" << std::endl;
